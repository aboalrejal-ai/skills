---
name: n8n-agents
description: Advanced n8n management and workflow automation agent.
metadata: {"openclaw":{"emoji":"🧵","requires":{"env":["N8N_API_KEY","N8N_BASE_URL"]}}}
---
...
- Create new automation logic.
- Debug and optimize current executions.
